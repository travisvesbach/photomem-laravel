<div>
    {{-- @if($alert) --}}
        <div class="alert alert-syncing" wire:loading.flex>
    ...
    <div class="row">
        ...
        <div class="actions">
            <button class="button" title="syncs all directories (no pictures)" wire:click="syncDirectories">Sync Directories</button>
        </div>
    </div>
