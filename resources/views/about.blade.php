...
@section('content')
    ...
    <p>
        To add directories, add them to (or symlink them in) <code>public/assets/sync/</code>.  Then go to the <a href="{{ route('directories') }}">Directories</a> page to sync the added directories into the system.  Once directories are synced, you can ignore directories and sync pictures in the directories you choose.
    </p>
    <p>
    ...
    <p>
        ...
        <a href="{{ route('pictures.random') }}">{{ route('pictures.random') }}</a>
    </p>
    ...
    <p>
        <a href="{{ route('pictures.random') }}?today=true&crop=960x540&color=gray&date=true">{{ route('pictures.random') }}?today=true&crop=960x540&color=gray&date=true</a> returns a picture taken today in history or random and crops it to 960x540 in grayscale with the date taken.
    </p>
