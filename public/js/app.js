...
function ajaxSync(url) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      $('#directories-synced-count').text(output.directories.filter(function (dir) {
        return dir.status === 'synced';
      }).length);
      ...
      output.directories.forEach(function (dir) {
        ...
        if (dir.status == 'ignored') {
          ...
          var _target = $('#directory-' + dir.id);

          _target.removeClass('disabled');

          _target.find('.ignored-hidden').show();

          _target.find('.ignored-show').hide();
        }
...
$(document).ready(function () {
  $('.accordion-control').on('click', function (e) {
    e.preventDefault();
    var open = !$(this).next('.accordion-panel').hasClass('open');
    console.log($(this).closest('.accordion'));
    $(this).closest('.accordion').find('.open').removeClass('open').slideToggle();

    if (open) {
      $(this).next('.accordion-panel').toggleClass('open').slideToggle();
    }
  });
});
